    ...
    <>
      ...
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M14.121 16.481c-.1.2-.209.34-.319.42-.11.08-.239.12-.369.12-.12 0-.239-.04-.339-.12-.1-.08-.18-.2-.239-.32L10.481 12l2.374-4.58c.06-.12.14-.24.239-.32.1-.08.219-.12.339-.12.13 0 .259.04.369.12.11.08.219.22.319.42L16.495 12l-2.374 4.48z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>
          ...
          <div className="keyboard-shortcuts-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="keyboard-shortcuts-content">
              ...
              <div className="keyboard-shortcuts-footer">
                <p>Press <kbd className="keyboard-key">Esc</kbd> to close this dialog</p>
              </div>
            </div>
          </div>
        </div>
