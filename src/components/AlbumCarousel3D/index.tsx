...
export const AlbumCarousel3D: React.FC<AlbumCarousel3DProps> = ({
  ...
  const navigateCarousel = (direction: 'prev' | 'next') => {
    ...
    if (direction === 'next') {
      ...
      setCurrentIndex(prev => (prev === 0 ? filteredAndSortedAlbums.length - 1 : prev - 1));
    }
...
const AlbumCard3D: React.FC<AlbumCard3DProps> = ({ album, isActive, onClick }) => {
  ...
  return (
    <div className={`album-card-3d ${isActive ? 'album-card-3d--active' : ''}`} onClick={onClick}>
      <div className='album-card-3d__inner'>
        <div className='album-card-3d__front'>
          <div className='album-card-3d__cover'>{renderCoverImage()}</div>
          ...
          <div className='album-card-3d__content'>
            ...
            {album.description && <p className='album-card-3d__description'>{album.description}</p>}
            ...
            <div className='album-card-3d__meta'>
              ...
              {album.isDefault && <span className='album-card-3d__badge'>Default</span>}
            </div>
          </div>
        </div>
        ...
        <div className='album-card-3d__back'>
          <div className='album-card-3d__back-content'>
            ...
            <ul>
              ...
              {album.tags.length > 0 && <li>Tags: {album.tags.join(', ')}</li>}
            </ul>
